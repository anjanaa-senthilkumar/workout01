---
author: "Anjanaa Senthil Kumar"
date: "October 2, 2018"
output: github_document
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE, fig.path = '../report/workout01-anjanaa-senthilkumar_files/')
...
*Yes, this was my first time using R Script. Using Markdown Syntax to separate different sections of code seems to make it easier to work through the file.
